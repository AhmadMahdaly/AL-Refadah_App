...
class AddBusDetailsCardTrip extends StatefulWidget {
...
class _AddBusDetailsCardTripState extends State<AddBusDetailsCardTrip> {
  late AddBusFormTripData form;
  BusesGetAllTransportsModel? selectedTransport;
  @override
  void initState() {
    super.initState();
    final state = context.read<AddBusTripCubit>().state;
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    context.read<AddBusTripCubit>().removeBusForm(widget.index);
                  },
                ),
              ],
            ),
            ...
            /// transport dropdown
            TransportsDropdownTrip(form: form),
