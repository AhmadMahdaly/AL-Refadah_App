...
import 'package:alrefadah/features/services_pages/buses_travel/select/widgets/select_trip_body.dart';
...
class _SelectTripPageState extends State<SelectTripPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      /// Body
      body: SelectTripBody(trip: widget.trip, searchText: searchText),
    );
  }
}
