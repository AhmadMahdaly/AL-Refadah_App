...
Future<String?> approvalTripMethod(
                    ...
                    return BlocBuilder<BusTravelCubit, BusesTravelState>(
                      builder: (context, state) {
                        if (state.isEditingTripByStage) {
                          return const AppIndicator();
                        } else if (state.isLoadingTripsByStage) {
                          return const AppIndicator();
                        } else {
                          return Row(
                            spacing: 12.w,
                                  ...
                                  onTap: () async {
                                    if (context.mounted) {
                                      final inputs = AddTripModel(
                                        ...
                                        /// تاريخ الوصول
                                        fReceiptDate: trip.fReceiptDate,

                                        /// المستلم
                                        fReceiptUser: int.tryParse(
                                          trip.fReceiptUser,
                                        ),
