class BusesTravelGetSeasonModel {
  BusesTravelGetSeasonModel({
  ...
  factory BusesTravelGetSeasonModel.fromJson(Map<String, dynamic> json) {
    return BusesTravelGetSeasonModel(
