...
import 'package:alrefadah/features/services_pages/buses_travel/incoming/views/incoming_confirm_dialog.dart';
...
class IncomingBusesPage extends StatefulWidget {
  const IncomingBusesPage({required this.trip, super.key});
  final BusesTravelGetTripModel trip;

  @override
  State<IncomingBusesPage> createState() => _IncomingBusesPageState();
}

class _IncomingBusesPageState extends State<IncomingBusesPage> {
  @override
  void initState() {
    super.initState();
    _initSearchListener();
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<BusTravelCubit, BusesTravelState>(
      builder: (context, state) {
        final buses = state.incomingTripsByStage;
        return Scaffold(
          appBar: AppBar(
          ...
          body:
              state.isLoadingIncomingTripByStage
                  ? const AppIndicator()
