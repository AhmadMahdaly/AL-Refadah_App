...
import 'package:alrefadah/features/services_pages/buses_travel/incoming/select/widgets/select_incoming_trips_body.dart';
...
class SelectIncomingTripsPage extends StatefulWidget {
  const SelectIncomingTripsPage({required this.trip, super.key});
  final BusesTravelGetTripModel trip;

  @override
  State<SelectIncomingTripsPage> createState() =>
      _SelectIncomingTripsPageState();
}

class _SelectIncomingTripsPageState extends State<SelectIncomingTripsPage> {
  @override
  void initState() {
    super.initState();
    _initSearchListener();
    context.read<BusTravelCubit>().getIncomingTripsByStage(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SelectIncomingTripsBody(searchText: searchText),
    );
  }
}
