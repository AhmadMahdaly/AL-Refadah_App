...
import 'package:alrefadah/features/services_pages/buses_travel/launch/select/views/select_launch_trips_page.dart';
...
class LaunchTripsPilgrimsTab extends StatelessWidget {
  const LaunchTripsPilgrimsTab({
    required this.trip,
    required this.remainingPilgrimsCount,
    super.key,
  });

  final BusesTravelGetTripModel trip;
  final int remainingPilgrimsCount;
                    ...
                    onSelected: (value) {
                      if (value == 'select') {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder:
                                (context) => SelectLaunchTripsPage(trip: trip),
                          ),
                        );
                      }
                    },
