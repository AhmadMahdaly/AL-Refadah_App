class TranferStageSharesGetSeasonsModel {
  TranferStageSharesGetSeasonsModel({
  ...
  factory TranferStageSharesGetSeasonsModel.fromJson(
    Map<String, dynamic> json,
  ) {
    return TranferStageSharesGetSeasonsModel(
