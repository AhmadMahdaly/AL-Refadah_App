class TransferStageSharesGetStageModel {
  TransferStageSharesGetStageModel({
  ...
  factory TransferStageSharesGetStageModel.fromJson(Map<String, dynamic> json) {
    return TransferStageSharesGetStageModel(
