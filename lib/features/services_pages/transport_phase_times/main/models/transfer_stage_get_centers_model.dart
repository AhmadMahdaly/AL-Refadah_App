class TransferStageGetCenterModel {
  TransferStageGetCenterModel({
  ...
  factory TransferStageGetCenterModel.fromJson(Map<String, dynamic> json) {
    return TransferStageGetCenterModel(
