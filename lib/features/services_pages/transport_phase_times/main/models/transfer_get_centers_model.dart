class TransferStageSharesGetCenterModel {
  TransferStageSharesGetCenterModel({
  ...
  factory TransferStageSharesGetCenterModel.fromJson(
    Map<String, dynamic> json,
  ) {
    return TransferStageSharesGetCenterModel(
