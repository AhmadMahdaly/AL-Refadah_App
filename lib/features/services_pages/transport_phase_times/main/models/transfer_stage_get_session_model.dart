class TranferStageGetSeasonsModel {
  TranferStageGetSeasonsModel({
  ...
  factory TranferStageGetSeasonsModel.fromJson(Map<String, dynamic> json) {
    return TranferStageGetSeasonsModel(
