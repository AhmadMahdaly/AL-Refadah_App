class TransferStageSharesGetByCriteriaModel {
  TransferStageSharesGetByCriteriaModel({
  ...
  factory TransferStageSharesGetByCriteriaModel.fromJson(
    Map<String, dynamic> json,
  ) {
    return TransferStageSharesGetByCriteriaModel(
