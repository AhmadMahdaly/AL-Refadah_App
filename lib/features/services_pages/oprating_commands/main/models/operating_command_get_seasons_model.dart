class OperatingCommandsGetSeasonsModel {
  OperatingCommandsGetSeasonsModel({
  ...
  factory OperatingCommandsGetSeasonsModel.fromJson(Map<String, dynamic> json) {
    return OperatingCommandsGetSeasonsModel(
