...
class _GuideSelectorBodyState extends State<GuideSelectorBody> {
  ...
  Widget build(BuildContext context) {
    final selectedEmpNos = selectedCards
    ...
    return BlocBuilder<GuidesCubit, GuidesState>(
      builder: (context, state) {
        return Scaffold(
          ...
          body: state.isLoadingAddGuides || state.isLoadingGuides
              ? const AppIndicator()
          ...
          bottomNavigationBar: state.isLoadingAddGuides || state.isLoadingGuides
              ? const SizedBox()
              : Padding(
                  ...
                  child: CustomButton(
                    ...
                    onTap: () async {
                      try {
                        final models = selectedCards
                            .where((card) => card.selectedEmployee != null)
                            .map((card) {
                        ...
                        for (final model in models) {
                          try {
                            ...
                            final duplicateEmpNo = empNoMatch != null
