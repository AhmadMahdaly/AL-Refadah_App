...
class ComplaintTravelCentersDropdown extends StatefulWidget {
  const ComplaintTravelCentersDropdown({super.key});

  @override
  State<ComplaintTravelCentersDropdown> createState() =>
      _ComplaintTravelCentersDropdownState();
}

class _ComplaintTravelCentersDropdownState
    extends State<ComplaintTravelCentersDropdown> {
  @override
  void initState() {
    initData();
    super.initState();
  ...
  void _onCenterChanged(String? value) {
    if (value != null) {
      setState(() {
        ...
        BlocProvider.of<BusTravelCubit>(context).getComplaint(value, '1');
      });
    }
  }
}
